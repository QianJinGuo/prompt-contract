...
![Real PromptContract Playground UI — provider and profile controls, prompt input, and enhanced structured output in a BYOK browser interface.](docs/assets/hero-cover.png)
