...
![Playground running its self-contained demo: a vague request enhanced into a structured task spec, six rule assertions passing](https://raw.githubusercontent.com/QianJinGuo/prompt-contract/main/docs/assets/hero-playground.png)
